...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모타입으로 자식 조회시 자식이 둘 있으면 중복오류 발생")
    ...
    void findBeanByParentTypeBeanName(){
        DiscountPolicy rateDiscoiuntPolicy = ac.getBean("rateDiscountPolicy",DiscountPolicy.class);
        assertThat(rateDiscoiuntPolicy).isInstanceOf(RateDiscountPolicy.class);
    }

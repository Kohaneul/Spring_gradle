...
public class OrderServiceTest {
    ...
    public void 주문취소() throws Exception{
        ...
        //when
        orderService.cancelOrder(orderId);  //8 -> 10

        //then
        Order getOrder = orderRepository.findOne(orderId);
        Assert.assertEquals("주문 취소시 상태는 CANCEL이 되어야 한다.",OrderStatus.CANCEL,getOrder.getOrderStatus());
        Assert.assertEquals("주문이 취소된 상품은 재고가 증가해야한다.",10,book.getStockQuantity());
    }
